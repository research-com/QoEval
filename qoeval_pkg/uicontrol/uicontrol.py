...
from qoeval_pkg.uicontrol.usecase import UseCaseType, UseCaseState
from qoeval_pkg.uicontrol.usecasefactory import UseCaseFactory
...
if __name__ == '__main__':
    ...
    # Youtube App app:
    ui_control.set_use_case(UseCaseType.APP_LAUNCH, package="com.google.android.youtube",
