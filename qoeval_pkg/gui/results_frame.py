...
class ResultsFrame(tk.Frame):
    ...
    def update_display(self):
        ...
        self.filenames = os.listdir(self.gui.qoeval_config.video_capture_path.get())
        self.filenames = [filename for filename in self.filenames
                          if os.path.isfile(os.path.join(self.gui.qoeval_config.video_capture_path.get(), filename))]
        stimuli = set()
    ...
    def on_video_select(self, *unused):
        ...
        for filename in self.filenames:
            if filename.startswith(self.listbox_stimuli.get(self.listbox_stimuli.curselection())) \
                ...
                video_path = os.path.join(self.gui.qoeval_config.video_capture_path.get(), filename)
        ...
        try:
            ...
            for filename in self.filenames:
                if filename.startswith(self.listbox_stimuli.get(self.listbox_stimuli.curselection())) \
                    ...
                    pdf_path = os.path.join(self.gui.qoeval_config.video_capture_path.get(), filename)
    ...
    def open_video_player(self):
        ...
        args = self.gui.qoeval_config.trigger_image_path.get() + " " + " ".join(self.selected_video_paths)
    ...
    def on_graph_select(self, *args):
        ...
        try:
            for filename in self.filenames:
                if filename.startswith(self.listbox_stimuli.get(self.listbox_stimuli.curselection())) \
                        and filename.endswith("_stats_" + self.listbox_graphs.get(self.listbox_graphs.curselection())):
                    image_path = os.path.join(self.gui.qoeval_config.video_capture_path.get(), filename)
