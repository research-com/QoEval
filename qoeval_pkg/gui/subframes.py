...
import qoeval_pkg.analysis.analysis
from qoeval_pkg.gui.config import *
from tkinter import filedialog, messagebox
from qoeval_pkg.configuration import *
import logging as log
from qoeval_pkg.gui.tooltip import Tooltip
...
class PlotsFrame(tk.Frame):
    ...
    def __init__(self, master, gui: Gui, config_variable: ListOption, name: str = None, value_name: str = "Value"):
        ...
        for direction in qoeval_pkg.analysis.analysis.DIRECTIONS:
            variable = tk.IntVar()
            ...
            if direction == qoeval_pkg.analysis.analysis.IN:
                checkbox.select()
        ...
        for protocol in qoeval_pkg.analysis.analysis.PROTOCOLS:
            variable = tk.IntVar()
            ...
            checkbox.pack(fill=tk.BOTH, expand=0, side="left")
            if protocol == qoeval_pkg.analysis.analysis.ALL:
                checkbox.select()
        ...
        for i, kind in enumerate(qoeval_pkg.analysis.analysis.KINDS):
