...
import qoeval_pkg.analysis.analysis as analysis
...
class AnalysisFrame(tk.Frame):
    ...
    def __init__(self, master, gui: Gui):
        ...
        self.plot_frame = BooleanFrame(self, self.gui,
                                       config_variable=self.gui.qoeval_config.traffic_analysis_plot,)
        ...
        self.live_visualization_frame = BooleanFrame(self, self.gui,
                                                     config_variable=self.gui.qoeval_config.traffic_analysis_live)
        ...
        self.bin_size_frame = ListIntegerFrame(self, self.gui,
                                               config_variable=self.gui.qoeval_config.traffic_analysis_bin_sizes,
        ...
        self.bin_size_frame = PlotsFrame(self, self.gui,
                                         config_variable=self.gui.qoeval_config.traffic_analysis_plot_settings,
