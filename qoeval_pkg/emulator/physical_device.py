...
from qoeval_pkg.emulator.mobiledevice import check_ext, MobileDevice, MobileDeviceOrientation, \
...
class PhysicalDevice(MobileDevice):
    def __init__(self, qoeval_config: QoEvalConfiguration, mirror: bool = True):
...
def main():
    ...
    pd = PhysicalDevice(QoEvalConfiguration())
