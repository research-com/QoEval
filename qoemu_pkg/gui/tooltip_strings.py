...
def add_tooltips(qoemu_config: QoEmuConfiguration):
    ...
    qoemu_config.traffic_analysis_bin_sizes.tooltip = 'Bin size thresholds [B] for creating packet histograms'
    ...
    qoemu_config.traffic_analysis_plot.tooltip = 'Enable traffic analysis'
